...
const types = {
  parent: {
    ...
    "primary-light":
      "background-primary-1 color-primary-7 hover:color-primary-8 hover:background-opacity-primary-4",
    "primary-link":
      "background-transparent color-primary-7 hover:background-primary-1",

    // Secondary buttons
    secondary:
      "background-secondary-7 hover:background-secondary-6 color-white",
    "secondary-light":
      "background-secondary-1 color-secondary-7 hover:color-secondary-8 hover:background-opacity-secondary-4",
    "secondary-link":
      "background-transparent color-secondary-7 hover:background-secondary-1",
    ...
    "tertiary-link":
      "background-transparent color-tertiary-7 hover:background-tertiary-1",

    // Cancel buttons
    cancel: "background-neutral-7 hover:background-neutral-6 color-white",
    "cancel-light":
      "background-neutral-1 color-neutral-7 hover:color-neutral-8 hover:background-opacity-neutral-4",
    "cancel-link":
      "background-transparent color-neutral-7 hover:background-neutral-1",

    // Delete buttons
    delete: "background-error-7 hover:background-error-6 color-white",
    "delete-light":
      "background-error-1 color-error-7 hover:color-error-8 hover:background-opacity-error-4",
  ...
  (
    ...
    return (
      <button
        ...
        type="submit"
        onClick={onClick}
        className={`border-radius-xs text-align-center transition-fast ${
          sizes.parent[size]
      ...
      >
        ...
        >
          {loading ? (
            <i
              className={`icon-system-loader-4-line opacity-7 button-loading margin-right-xxs ${sizes.icon[size]}`}
            />
          ) : (
            iconLeft && (
              <i
