    ...
    <li>
      <a
        ...
        className={classNames(
          'hover:background-neutral-1 active:background-neutral-4 padding-xs padding-top-xxs padding-bottom-xxs border-radius-xs display-flex align-items-center transition-fast',
          themes.parent[theme],
          className,
        )}>
